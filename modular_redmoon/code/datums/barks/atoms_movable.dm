...
/atom/movable/proc/handle_special_bark(atom/movable/source, list/hearers, distance, volume, pitch)
	...
	switch(GLOB.bark_list[source.vocal_bark_id])
		if(/datum/bark/gaster)
			soundpaths = list(
				'modular_redmoon/sound/barks/voice_gaster_1.ogg',
				'modular_redmoon/sound/barks/voice_gaster_2.ogg',
				'modular_redmoon/sound/barks/voice_gaster_3.ogg',
				'modular_redmoon/sound/barks/voice_gaster_4.ogg',
				'modular_redmoon/sound/barks/voice_gaster_5.ogg',
				'modular_redmoon/sound/barks/voice_gaster_6.ogg',
				'modular_redmoon/sound/barks/voice_gaster_7.ogg'
			)
		else
