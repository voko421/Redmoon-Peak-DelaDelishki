...
/obj/item/ramrod
	name = "ramrod"
	icon = 'modular_redmoon/icons/obj/arquebus_items.dmi'
...
/obj/item/gun/ballistic/firearm
	...
	icon = 'modular_redmoon/icons/obj/arquebus.dmi'
	icon_state = "arquebus"
	item_state = "arquebus"
	force = 10
	force_wielded = 15
	...
	load_sound = 'modular_redmoon/sound/arquebus/musketload.ogg'
	fire_sound = 'modular_redmoon/sound/arquebus/arquefire.ogg'
...
/obj/item/gun/ballistic/firearm/shoot_with_empty_chamber()
	playsound(src.loc, 'modular_redmoon/sound/arquebus/musketcock.ogg', 100, FALSE)
	update_icon()
...
/obj/item/gun/ballistic/firearm/handgonne
	name = "handgonne"
	desc = "A gunpowder weapon that shoots an armor piercing metal ball."
	icon = 'modular_redmoon/icons/obj/handgonne.dmi'
...
/obj/item/gun/ballistic/firearm/flintgonne
	name = "flintgonne"
	desc = "A gunpowder weapon that shoots an armor piercing metal ball."
	icon = 'modular_redmoon/icons/obj/flintgonne.dmi'
...
/obj/item/gun/ballistic/firearm/blunderbuss
	...
	lefthand_file = 'modular_redmoon/icons/mob/guns_lefthand.dmi'
	righthand_file = 'modular_redmoon/icons/mob/guns_righthand.dmi'
