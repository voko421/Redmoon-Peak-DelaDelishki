...
/datum/advclass/seneschal/headmaid
	name = "Head Maid"
	tutorial = "Независимо от того, повысили ли вас в должности или вам просто нравятся "оборки", вы выдаете себя за старшую горничную. Однако ваши обязанности и таланты остаются прежними."

/datum/advclass/seneschal/chiefbutler
	name = "Chief Butler"
	tutorial = "Вы принадлежите к правящему классу дворецких, и ваше умение прочистить горло и пробормотать "Я сказал" не имеет себе равных. Однако ваши обязанности и таланты как сенешаля остаются прежними."
