/datum/job/roguetown/bogguardsman
	...
	tutorial = "Будучи обычным жителем малонаселенных лесов Азурии, вы добровольно вступили в ряды стражей - группы рейнджеров, которые охраняют дикую природу. \
				Хотя стражи не имеют высших полномочий и действуют как братство рейнджеров, маршал или корона призвали вас в качестве членов гарнизона. \
